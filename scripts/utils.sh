...
function appear_as() {
  ...
  export ORDERER_ENDPOINT=org0-orderernode1-orderer.org1.fyre.ibm.com:443
  export ORDERER_TLS_CERT=${PWD}/channel-config/organizations/ordererOrganizations/org1.fyre.ibm.com/orderers/orderernode1/tls/signcerts/tls-cert.pem
}
