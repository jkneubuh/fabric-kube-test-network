...
#
ORG_DIR=channel-config/organizations/peerOrganizations/garboard3.fyre.ibm.com
...
#
ORG_DIR=channel-config/organizations/ordererOrganizations/garboard3.fyre.ibm.com
