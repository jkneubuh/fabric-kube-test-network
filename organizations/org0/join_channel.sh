...
function join_orderer() {
  ...
  local orderer_admin_endpoint=org0-${orderer}-admin.garboard1.fyre.ibm.com
  local ca_file=channel-config/organizations/ordererOrganizations/garboard1.fyre.ibm.com/orderers/${orderer}/tls/signcerts/tls-cert.pem
